    ...
    Index: () => {
        return new Promise((res, rej) => {
            ...
            $("body").prepend(Template.Sidebar('./assets/img/Logo.png', [
                ...
                { fn: 'Init.PendientesPapel()', page: 'PendientesPapel', icon: 'assignment_late', name: 'Pendientes' },
                { fn: 'Init.ImpresionesPapel()', page: 'ImpresionesPapel', icon: 'assignment', name: 'Impresiones' },
